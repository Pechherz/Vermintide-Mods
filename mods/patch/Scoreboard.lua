...
--edit--
		if player_index == 1 then
			...
			player_name = "Health gained, melee/ranged/total\n" .. "Ammo gained, melee/ranged/total"
		end
...
--edit--
		-- if player_index == 2 then
			-- widget.style.title_text.text_color[1] = widget.style.title_text.text_color_orig or widget.style.title_text.text_color[1]
			-- widget.style.score_text.text_color[1] = widget.style.score_text.text_color_orig or widget.style.score_text.text_color[1]
			-- widget.style.icon.color[1] = widget.style.icon.color_orig or widget.style.icon.color[1]
			-- widget.style.highlight.color[1] = widget.style.highlight.color_orig or widget.style.highlight.color[1]
		-- end
--edit--
	end
